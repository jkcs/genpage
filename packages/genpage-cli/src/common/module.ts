...
function resolveFallback (request: any, options: any) {
  const isMain = false
...
export const resolveModule = function (request: any, context: any) {
...
export const loadModule = function (request: any, context: any, force = false) {
...
export const clearModule = function (request: any, context: any) {
  const resolvedPath = exports.resolveModule(request, context)
  if (resolvedPath) {
    clearRequireCache(resolvedPath)
  }
...
function clearRequireCache (id: any, map = new Map()) {
